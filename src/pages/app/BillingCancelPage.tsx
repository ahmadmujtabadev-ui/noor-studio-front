...
export default function BillingCancelPage() {
  return (
    <AppLayout title="Payment Canceled" subtitle="Your checkout session was canceled">
      <div className="max-w-2xl mx-auto">
        <div className="card-glow p-8 text-center">
          ...
          <div className="bg-muted/50 rounded-lg p-6 mb-8">
            <h3 className="font-medium mb-3 flex items-center justify-center gap-2">
              <HelpCircle className="w-4 h-4" />Common reasons for canceling:
            </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button asChild>
              <Link to="/app/billing"><ArrowLeft className="w-4 h-4 mr-2" />Return to Billing</Link>
            </Button>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-muted-foreground">Have questions? Contact support@noorstudio.ai</p>
        </div>
      </div>
    </AppLayout>
  );
