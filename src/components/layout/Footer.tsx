...
const footerLinks = {
  product: [
    { label: "Character Studio", href: "/product#characters" },
    { label: "Book Builder", href: "/product#books" },
...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:hello@noorstudio.app", label: "Email" },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">
                Noor<span className="text-gold-400">Studio</span>
              </span>
            </Link>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-white/50">
            © {new Date().getFullYear()} Noor Studio. All rights reserved.
          </p>
          <p className="text-sm text-white/50">
