...
export const ISLAMIC_VALUE_TILES = [
  { value: "Sabr — patience in hardship and difficulty",                            label: "Sabr",        icon: IconSabr,        image: "/vocabulary/sabar.png",       bg: "bg-violet-100", ring: "ring-violet-500", text: "text-violet-700" },
  { value: "Shukr — gratitude to Allah for all blessings",                          label: "Shukr",       icon: IconShukr,       image: "/vocabulary/sukar.png",       bg: "bg-amber-100",  ring: "ring-amber-500",  text: "text-amber-700"  },
  { value: "Sadaqah — giving generously to those in need",                          label: "Sadaqah",     icon: IconSadaqah,     image: "/vocabulary/sadaqah.png",     bg: "bg-rose-100",   ring: "ring-rose-500",   text: "text-rose-700"   },
  { value: "Sidq — honesty and truthfulness in all situations",                     label: "Honesty",     icon: IconHonesty,     image: "/vocabulary/honesty.png",     bg: "bg-green-100",  ring: "ring-green-500",  text: "text-green-700"  },
  { value: "Rahma — kindness and compassion toward all living things",              label: "Kindness",    icon: IconKindness,    image: "/vocabulary/kindness.png",    bg: "bg-orange-100", ring: "ring-orange-500", text: "text-orange-700" },
  { value: "Tawakkul — trusting Allah after doing your best",                       label: "Tawakkul",    icon: IconTawakkul,    image: "/vocabulary/tawakkul.png",    bg: "bg-blue-100",   ring: "ring-blue-500",   text: "text-blue-700"   },
  { value: "Salah — establishing prayer as the anchor of every day",                label: "Salah",       icon: IconSalah,       image: "/vocabulary/salah.png",       bg: "bg-emerald-100",ring: "ring-emerald-500",text: "text-emerald-700"},
  { value: "Respecting parents and elders with love and care",                      label: "Respect",     icon: IconRespect,     image: "/vocabulary/respect.png",     bg: "bg-purple-100", ring: "ring-purple-500", text: "text-purple-700" },
  { value: "Afw — forgiveness, letting go of anger for Allah's sake",               label: "Forgiveness", icon: IconForgiveness, image: "/vocabulary/forgiveness.png", bg: "bg-pink-100",   ring: "ring-pink-500",   text: "text-pink-700"   },
  { value: "Saying Bismillah before every action",                                  label: "Bismillah",   icon: IconBismillah,   image: "/vocabulary/bismillah.png",   bg: "bg-teal-100",   ring: "ring-teal-500",   text: "text-teal-700"   },
  { value: "Taharah — cleanliness of body, clothes, and space",                     label: "Taharah",     icon: IconCleanliness, image: "/vocabulary/taharah.png",     bg: "bg-sky-100",    ring: "ring-sky-500",    text: "text-sky-700"    },
  { value: "Courage to do right even when it is difficult",                         label: "Courage",     icon: IconCourage,     image: "/vocabulary/courage.png",     bg: "bg-yellow-100",   ring: "ring-yellow-500",  text: "text-yellow-700"  },
  { value: "Ihsan — doing every action with excellence and beauty",                 label: "Ihsan",       icon: IconIhsan,       image: "/vocabulary/ihsan.png",       bg: "bg-indigo-100",   ring: "ring-indigo-500",  text: "text-indigo-700"  },
